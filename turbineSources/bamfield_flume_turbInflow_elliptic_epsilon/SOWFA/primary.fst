--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
DOE Tidal Turbine Reference Model - UW lab-scale turbine model_6
Compatible with FAST v6.0. (or at least openFAST v7)
---------------------- SIMULATION CONTROL --------------------------------------
...
267.38   RotSpeed    - Initial or fixed rotor speed (rpm)  [for U_inflow = 0.9 m/s TSR = 7.0]
   0.0      NacYaw      - Initial or fixed nacelle-yaw angle (degrees)
   0.0      TTDspFA     - Initial fore-aft tower-top displacement (meters)
   0.0      TTDspSS     - Initial side-to-side tower-top displacement (meters)
---------------------- TURBINE CONFIGURATION -----------------------------------
  0.225000  TipRad      - The distance from the rotor apex to the blade tip (meters)
  0.0508    HubRad      - The distance from the rotor apex to the blade root (meters)
