...
\subsection{Future Work}
	...
	\begin{frame}{Future Work}
		...
		\begin{itemize}
			\item \small Code and Computers
				\begin{itemize}
					\item \small prototype simulations for running on more powerful hardware
			...
			\item \small Ambient Turbulence
				\begin{itemize}
					\item \small turbulent structures within ambient flow can cause loading events with significance comparable to when turbines operate in upstream wakes
					\item boundary data on inlet planes generated from either precursor LES or synthetic turbulence methods (e.g. pyTurbSim)
				\end{itemize}

			\item \small Control Strategies
				\begin{itemize}
					\item \small dynamical model of rotor drivertrain to allow variable TSR as response to fluctuations in rotor torque
...
\subsection{RANS-experiment-setup}
	...
	\begin{frame}{}
		...
		\footnotetext{\footnotesize T. Javaherchi, N. Stelzenmuller, A. Aliseda (2013, 2014) }
